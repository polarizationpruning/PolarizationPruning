...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, bn_init_value, num_classes=10, aux_fc=False):
...
def resnet56(num_classes, bn_init_value, aux_fc):
    return ResNet(BasicBlock, [9, 9, 9], num_classes, bn_init_value, aux_fc=aux_fc)
